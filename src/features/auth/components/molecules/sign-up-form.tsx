...
const LoginForm = ({ className }: Props) => {
  ...
  return (
    <form action={action} className={cn("", className)}>
      ...
      <InputWithLabel name="name" label="Name" type="text" placeholder="Name" />
      ...
      <Button disabled={isPending} type="submit" className="bg-[#DB4444] text-white px-8 py-6 w-full mt-4 hover:cursor-pointer">
        Create Account
      </Button>
      <Button variant="outline" className="w-full px-8 py-6 my-4 hover:cursor-pointer" >
